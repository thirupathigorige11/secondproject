...
<%-- <input type="hidden" name="strPONumber" id="strPONumber" value="<%=vendorId%>">
<input type="hidden" name="strPONumber" id="strPONumber" value="<%=oldPOEntryId%>">
<input type="hidden" name="strPONumber" id="strPONumber" value="<%=strPONumber%>"> --%>
...
%>
 ...
 if(getLocalPort == 8080){ //local machine
 ...
 PurchaseDepartmentIndentProcessDaoImpl obj1 = (PurchaseDepartmentIndentProcessDaoImpl) context.getBean("purchaseDeptIndentrocessDao1");
	String cancel=obj1.getCancelOrNot(strPONumber);
	String checkval=obj1.checkApproveStatus(strPONumber);
	String dbPasswd=obj1.getTempPOPassword(strPONumber,false);
	log(cancel);
...
%> 
 ...
 <center><font color="red" size="5"><c:out value="Already Approved or Modified or Cancelled"></c:out> </font></center>
 <%} %>
...
function Cancel() {
	...
	document.getElementById("CreateCentralIndentFormId").action = "ModifyTempPoMail.spring";
...
function Reject() {
	...
	document.getElementById("CreateCentralIndentFormId").action = "CancelMailMarketingTempPO.spring";
	document.getElementById("CreateCentralIndentFormId").method = "POST";
	document.getElementById("CreateCentralIndentFormId").submit();
}

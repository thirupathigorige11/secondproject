	...
	<div class="container body">
		<div class="main_container" id="main_container">
			...
			<div class="right_col" role="main">
				...
				<div class="col-md-12">
					<div class="container container-viewmyworkorder">
						 <form class="form-horizontal" action="${pageAction}">
							<div class="col-md-12">
								<div class="col-md-12">
								 <div class="col-md-5">
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" id="ReqDateId1" class="form-control" name="fromDate" value="${fromDate}" autocomplete="off" placeholder="dd-mm-yy" onkeydown="return false">
										</div>
									</div>
								</div>
								...
								<div class="col-md-5">
									<div class="form-group">
										...
										<div class="col-md-9">
										  <input type="text" id="ReqDateId2" class="form-control" name="toDate" placeholder="dd-mm-yy" value="${toDate}" autocomplete="off" onkeydown="return false">
										</div>
									</div>
								</div>
								</div>
							...
							<div class="col-md-7 col-md-offset-2">
								<div class="form-group">
									<label for="todate" class="col-md-6">Temp Work Order Number :</label>
									<div class="col-md-6">
							...
							<div class="clearfix"></div>
							 <div class="col-md-12 text-center center-block">
								<button type="submit" value="Submit" id="saveBtnId" class="btn btn-warning media-style Mrgtop20" onclick="return validate();">Submit</button>
							</div>
							</div>
						</form>
						</div>

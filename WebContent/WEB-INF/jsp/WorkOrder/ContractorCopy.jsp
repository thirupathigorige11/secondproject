...
@media print{
.nav_menu, .breadcrumb, .btn-print-contractorcopy, .print_hide{
display:none;
}
...
<div class="overlay_ims" ></div>
       ...
       <form:form modelAttribute="indentReceiveModelForm" id="contractorBill" class="form-horizontal" action="generateAdvancePaymentBill.spring">
		<div class="col-md-12">
         <div class="table-responsive">
          ...
          <tbody>
            <tr><td  class="text-center bck-ground" style="border:1px solid #000;"><h4><strong>${billBean.contractorName} </strong></h4></td></tr>
            <tr><td colspan="2" style="width:80%;border:1px solid #000;" class="text-center bck-ground"><h5><strong>Bill</strong></h5></td></tr>
          </tbody>
          </table>
         <table style="margin-bottom: -1px;border:1px solid #000;width:100%;font-weight:bold;" >
          <tbody>
            <tr>
			  ...
			  <div class=" " style="width:100%;"><div class="  mrg-Top" style="width:45%;float:left;"><strong>Pan Card No</strong> </div><div class=" mrg-Top"style="width:10%;float:left;"><strong>:</strong></div><div class=" mrg-Top"style="width:45%;float:left;">	 ${billBean.contractorPanNo}</div></div>
			  <div class="clearfix"></div>
			  
			  <div class="" style="width:100%;"><div class="mrg-Top"style="width:45%;float:left;"><strong>Account No</strong> </div><div class="mrg-Top"style="width:10%;float:left;"><strong>:</strong></div><div class=" mrg-Top"style="width:45%;float:left;"> ${billBean.contractorBankAccNumber}</div></div>
			  <div class="clearfix"></div>
              <div class="" style="width:100%;"><div class="mrg-Top"style="width:45%;float:left;"><strong>IFSC & Bank Name</strong>  </div><div class=" mrg-Top"style="width:10%;float:left;"><strong>:</strong></div><div class=" mrg-Top"style="width:45%;float:left;">
			  ...
			  <div class="clearfix"></div>
              <div class=" " style="width:100%;"><div class="mrg-Top" style="width:45%;float:left;"><strong>Mobile No  </strong></div><div class=" mrg-Top" style="width:10%;float:left;"><strong>:</strong></div><div class=" mrg-Top" style="width:45%;float:left;"> ${billBean.contractorPhoneNo}</div></div>
			  <div class="clearfix"></div> 
           ...
           <!--    <div class="" style="height:50px;"></div>  -->
			  ...
			  <div class="mrg-Top" style="width:45%;float:left;"><strong>Project</strong></div><div class="mrg-Top" style="width:10%;float:left;">:</div><div class="mrg-Top" style="width:45%;float:left;"><strong>${billBean.siteName}</strong></div>
			  	</div>
			  	<div class="clearfix"></div>
			  	 <div class="mrg-Top" style="width:100%;">
			  	<div  class="mrg-Top" style="width:45%;float:left;"><strong>Type of work</strong></div><div class="mrg-Top" style="width:10%;float:left;">:</div><div style="width:45%;float:left;"class="mrg-Top" id="typeOfWork">NMR Works</div>
			  </div>
			  <div class="clearfix"></div>
			   <div class="mrg-Top" style="width:100%;">
			    <div class="mrg-Top" style="width:45%;float:left;"><strong>Work order No</strong></div><div class="mrg-Top" style="width:10%;float:left;">:</div><div class="mrg-Top" style="width:45%;float:left;"> ${billBean.workOrderNo}
              ...
              <div class="clearfix"></div>
              <div class="" style="width:100%;">
              		<div style="width:45%;float:left;" class="mrg-Top">Bill No </div><div class="mrg-Top" style="width:10%;float:left;">:</div><div style="width:45%;float:left;" class="mrg-Top">${billBean.billNo }<input type="hidden"  class="border-none" style="display:inline;"  value=" ${billBean.billNo }" readonly="readonly"/></div>
              </div>
              	 <div class=""style="width:100%;">
             ...
             <div class="clearfix"></div>
               <div class="" style="width:100%;">
               <div class="mrg-Top" style="width:45%;float:left;"><strong>Bill Date</strong></div><div class="mrg-Top" style="width:10%;float:left;">:</div><div class=" mrg-Top" style="width:45%;float:left;">${billBean.paymentReqDate}</div>
               </div>
              </td>
            </tr>
          </tbody>
    ...
    <div class="col-md-12 text-center center-block btn-print-contractorcopy">
...
<script type="text/javascript">
	...
	//this code for to active the side menu 
	  var referrer="viewCompletedBills.spring";

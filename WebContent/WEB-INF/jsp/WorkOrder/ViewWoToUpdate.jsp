...
//validating from date, to date and work order number
	function validate() {
...
<body class="nav-md">
							...
							<!-- <div class="col-md-12"> -->
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" id="ReqDateId1" class="form-control"
												name="fromDate" value="${fromDate}" autocomplete="off" onkeydown="return false" placeholder="dd-mm-yy">
										</div>
									</div>
								</div>
								...
								<div class="col-md-5">
									<div class="form-group">
										...
										<div class="col-md-9">
										  <input type="text"
											id="ReqDateId2" class="form-control" name="toDate"
											value="${toDate}" autocomplete="off" onkeydown="return false" placeholder="dd-mm-yy">
										</div>
									</div>
								</div>
								</div>
 --%>							
							...
							<div class="col-md-12" style="">
								<div class="form-group">
									<label for="todate" class="control-label col-md-6 ">Temp Work Order Number :</label>
									<div class="col-md-6">
										<input type="text" id="siteWiseWorkOrderNo"
											class="form-control" name="siteWiseWorkOrderNo"
											value="${workOrderNumber}" autocomplete="off">
									</div>
								</div>
			    ...
			    <div class="table-responsive">
					<table id="tblnotification"	class="table table-striped table-bordered st-table" cellspacing="0">
						...
						<tr>
							...
							<td><a class="anchorcolour" href="viewMyWoToUpdate.spring?siteWiseWorkOrderNo=${element.siteWiseWONO}&tempWorkOrderIssueNo=${element.QS_Temp_Issue_Id}&siteId=${element.siteId}&status=true" title="click here to see work order details"> ${element.siteWiseWONO }</a> </td>

...
<body class="nav-md">
					...
					<div class="container border-inwards-box">
					   ...
					   <div class="col-md-12 text-center center-block" style="margin-top: 20px;margin-bottom: 40px;">
						...
						<form id="ViewGrnButtonsPageId">							 	             
								...
								<input type="hidden" name="dcEntryId" value="${dcEntryId}"/>
								<input type="hidden" name="type" value="dcGrn"/>
								...
								<div class="col-md-12 col-xs-12 col-sm-12 text-center center-block" style="margin-bottom: 40px;">
									<button type="button" value="View GRN" id="saveBtnId" class="btn btn-warning btn-sub-inwards" onclick="viewGrn()">View DC GRN</button>
	...
	function viewGrn(){
		document.getElementById("ViewGrnButtonsPageId").action = "getDcFormGrnViewDts.spring";

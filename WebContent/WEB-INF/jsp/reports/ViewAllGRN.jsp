...
<body class="nav-md">
			...
			<div class="right_col" role="main">
				<div>
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">Get GRN</li>
					</ol>
				</div>
 ...
 <div class=""> 
	...
	<form class="form-inline"  action="getGrnViewDts.spring">
   ...
   <%--  <div class="tetx-center">${displayErrMsg}</div> --%>
			...
			<div class="table-responsive">
				...
				<tr>
					...
					<td><a href="getGrnDetails.spring?invoiceNumber=${element.requesterId}&vendorId=${element.vendorId}&invoiceDate=${element.strInvoiceDate}&indentEntryId=${element.indentEntryId}&siteId=${element.siteId}&url=${url}fromDate=${fromDate}&toDate=${toDate}" class="anchor-class">${element.requesterId}</a></td>

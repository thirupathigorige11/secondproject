			...
			<div class="right_col" role="main">
				<div>
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">MIS Market Purchase Details</li>
					</ol>
				</div>
					...
					<div class="container">
						...
						<form class="form-horizontal">
						 <table id="mistableFixedheader" class="table table-bordered display table-fixed-header" style="width:100%;">
                            ...
                            <tbody>
                            <%
                            List<ProductDetails> poDetails = (List<ProductDetails>) request.getAttribute("MarketPurchaseDetails");
                            int i=1;

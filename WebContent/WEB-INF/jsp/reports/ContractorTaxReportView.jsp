		...
		<div class="main_container" id="main_container">
			...
			<div class="right_col" role="main">
				<div id="mydiv" class="hide-show-iframe">
					...
					<center><label class="success"><c:out value="Click below button to download table data in Excel"></c:out> </label></center> 
						    
				     			<input type="hidden" name="billFromDate"  value="${billFromDate}" />
								<input type="hidden" name="billToDate"  value="${billToDate}" />
								<input type="hidden" name="ContractorId"  value="${ContractorId}" />
								<input type="hidden" name="ContractorName"  value="${ContractorName}" />
								<input type="hidden" name="siteIds"  value="${siteIds}" />
...
<td></td>
<td></td>
<td>${element.woNumber}</td>
<td>${element.woDate}</td>
...
<td>${element.advanceDeduction}</td>
<td>${element.securityDeposit}</td>
<td>${element.otherDeductions}</td>
...
<td></td>
		...
		function setVedData() {
			...
			/* function saveRecords(saveClicked, rowId) {
				...
				document.getElementById("paymentIntiateFormId").action = "purchaseTaxReport.spring";
			...
			function saveRecords1(saveClicked, rowId) {
				...
				$(".loader-sumadhura").hide(); 
				document.getElementById("paymentIntiateFormId").action = "downloadContractorTaxReport.spring";
				document.getElementById("paymentIntiateFormId").method = "POST";
				document.getElementById("paymentIntiateFormId").submit();

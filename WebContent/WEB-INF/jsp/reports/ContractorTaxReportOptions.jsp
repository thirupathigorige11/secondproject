				...
				<div id="mydiv" class="hide-show-iframe">
					<div class="col-md-12">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active">Contractor Tax Report</li>
						</ol>
					</div>
					<!-- loader -->
					...
					<div class="col-md-12" id="hide-show-iframe">
						<div class="invoice-payment-heading">
							<h4 class="text-center">CONTRACTOR TAX REPORT</h4>
						</div>
						<div class="body-invoice-payment">
						    <div id = "resp-msg">
						    <center><label class="success"><font color='red'><c:out value="${requestScope['succMessage']}"></c:out></font> </label></center> 
						    </div><br>
							<form class="form-horizontal" id="paymentIntiateFormId">
								<div class="col-md-12 col-xs-12 col-sm-12">
									<div class="col-md-6 col-sm-6 col-xs-12">
										<div class="form-group">
											<label class="col-md-6 col-sm-6 col-xs-12"><strong>Bill Date From  :</strong></label>
											<div class="col-md-6 col-sm-6 col-xs-12 input-group">
												<input type="text" class="form-control control-text-height readonly-color"
													id="datepicker-invoice-fromdate" name="billFromDate"
									...
									<div class="col-md-6 col-xs-12 col-sm-6">
										<div class="form-group">
											<label class="col-md-6 col-sm-6 col-xs-12"><strong>Bill Date To  :</strong></label>
											<div class="col-md-6 col-sm-6 col-xs-12 input-group">
												<input type="text" class="form-control control-text-height readonly-color"
													id="datepicker-invoice-todate" name="billToDate"
								...
								<div class="col-md-12 col-xs-12 col-sm-12">
									<div class="col-md-6 col-sm-6 col-xs-12">
										<div class="form-group">
											<label class="col-md-6 col-sm-6 col-xs-12"><strong>Contractor Name :</strong></label>
											<div class="col-md-6 col-sm-6 col-xs-12 input-group">
												 <input type="text"  class="form-control border-none" id="ContractorName" style="width:100%;" name="ContractorName"  onkeyup="return populateData(this, event);"  autocomplete="off"   /><input type="hidden"  id="ContractorId" name="ContractorId"    />
		...
		function setVedData() {
 		...
 		$(document)
			...
			function saveRecords(saveClicked, rowId) {
				...
				document.getElementById("paymentIntiateFormId").action = "viewContractorTaxReport.spring";
			...
			function validate() {debugger;
			    ...
			    var ContractorIdId=ContractorId.trim();
			    
			    if (!InvoiceFromdate && !InvoiceTodate && (!ContractorNameId || !ContractorIdId) ) {

...
<style>
.table-new tbody tr td:first-child, .table-new thead tr th:first-child { min-width: 20px; text-align: center; width:50px;}
...
function createCell(cell, text, style, fldLength, cellsLen, tableColumnName) {
     ...
     if(tableColumnName == snoColumn) {
    	...
    	if(tableColumnName == productColumn) {
		    ...
		    div2.setAttribute("onblur", "return validateUnitsAndAvailability(this);");
				...
				<div class="right_col" role="main">
					<div>
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active">Receive Form</li>
						</ol>
					</div>
	...
	<div>
	 ...
	 <div class="row">
	  <div class="col-md-12">
			...
			<div class="col-md-6" >
				<form:input path="InvoiceNumber" id="InvoiceNumberId" class="form-control" autocomplete="off"/>
			...
			<div class="col-md-4">
			 <div class="form-group">
			<label class="control-label col-md-6 col-xs-12"> Invoice Date : </label>
			...
			<div class="col-md-6" >
				<form:input path="VendorName" id="VendorNameId" class="form-control vendor" />
			</div>
		   </div>
			</div>
		...
		<div class="col-md-4">
		 <div class="form-group">
			...
			<label class="control-label col-md-6 col-xs-12">PO Date : </label>
				<div class="col-md-6 col-xs-12 input-group">
					<form:input path="poDate" name="poDate" id="poDateId" class="form-control podate readonly-color" readonly="true"/>
		...
		<div class="col-md-4">
			...
			<div class="col-md-6" >
				<form:input path="eWayBillNo" name="eWayBillNo" id="eWayBillNoId" class="form-control"/>
			</div>
			</div>
			</div>
			<div class="col-md-4">
			...
			<div class="col-md-6">
				<form:input path="vehileNo" name="vehileNo" id="vehileNoId" class="form-control"/>
			...
			<div class="col-md-4">
			<div class="form-group">
			<label class="control-label col-md-6 col-xs-12">Received Date : </label>
			<div class="col-md-6 col-xs-12 input-group">
			...
			<div class="col-md-4">
			<div class="form-group">
		     <label class="control-label col-md-6" >Received From : </label>
			<div class="col-md-6" >
					<select path="typeOfPurchase" id="typeOfPurchase" class="form-control" name="typeOfPurchase" style="padding: 3px;" onchange='Checklist(this.value);'>
		...
		<div  id="others-divpo" style="display: none;">
			...
			<div class="col-md-6" >
					<form:input path="" name="poNumber" onblur="validatePoNum()" id="poNumber"
...
<!-- ******************************************** -->
			...
			<table id="doInventoryTableId" class="table table-new pro-table" style="width:4600px;">
			<thead class="cal-thead-inwards"> <!-- style="color: #000;;background: #ccc;display:block;" -->
				<tr >
  			...
  			<tbody class="tbl-fixedheader-tbody">
				<tr id="productchargesrow1" class="producttable">
					...
					<td  class="s-50">
                        ...
                        <form:input path="groupId1" id="groupId1" type="hidden" value=""/>
...
<!-- ***********Transport Charges grid start here****************** -->
			...
			<table id="doInventoryChargesTableId" class="table table-new pro-table tbl-width-medium">
			...
			<tbody class="tbl-fixedheader-tbody">
				<tr id="chargesrow1">
					...
					<td>
						...
						<form:input path="ConveyanceAmount1" id="ConveyanceAmount1" name="ConveyanceAmount1" type="number"  placeholder="Please enter Amount"  class="form-control noneClass" autocomplete="off"/>
					</td>
					<td>
...
<div class="file-upload" style="float: left; color: orange;font-size: 14px;margin-top: 10px;font-weight: bold">
	...
	<input type="file" name="file"><br><input type="file" name="file"><br>
			...
			<input type="hidden" name="SiteId" id="SiteId" value="<%= session.getAttribute("SiteId") %>" />

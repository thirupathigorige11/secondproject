...
<div style="width:100%;">
    ...
    width: 30%;text-align: center;font-size: 22px;font-weight: bold;border: 2px solid black;float: left;margin-top: 6px;height: 137px;margin-left: 26px;">Purchase Order</span></div>
	...
	<div class="bAddress" style="    margin-top: 28px;">
		<div class="header-content2"
			...
			<span class="text-alignment-content"> Ref No: </span><span
				class="colon-conent" style="margin-left: 40px;">:</span><%=strPONumber%><br>
			<span class="text-alignment-content">Date</span><span
	...
	<table  style="border:1px solid #000;font-family: Calibri; margin-top: 97px;margin-left: 20px;"> <!-- class="table table-bordered" -->
		<tbody>
	...
	<table style="border:1px solid #000;font-family: Calibri;    font-weight: bold;margin-top: 98px;width: 1050px;;margin-left: 20px;">  <!-- class="table table-bordered" -->
		<tbody>

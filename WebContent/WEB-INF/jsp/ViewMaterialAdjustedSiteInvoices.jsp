...
<link rel="shortcut icon" type="image/x-icon" href="images/favicon.jpg">
  <style>
     ...
     .form-control{height:36px;border:1px solid #000;}
...
<body class="nav-md">
	<div class="container body">
		<div class="main_container" id="main_container">
			...
			<div class="right_col" role="main">
				<div class="col-md-12">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">Get Adjusted Material Details</li>
					</ol>
				</div>
			...
			<form class="form-inline"  action="getMaterialAdjInvoiceReciveDtls.spring" >    
              ...
              <button type="submit"  value="Submit" id="saveBtnId" class="btn btn-warning btn-sub-inwards" onclick="return validate();">Submit</button>
            </form>	
            </div>
          </div>
          <div class="clearfix"></div>
	           <%
				...
				<div class="table-responsive"> <!--  container1 -->
					<table id="tblnotification"	class="table table-new" cellspacing="0">
				       ...
				       <c:forEach items="${indentIssueData}" var="element">  
						<tr>
				          ...
				          <td><a href="getInvoiceDetails.spring?invoiceNumber=${element.strNumber}&vendorName=${element.vendorName}&vendorId=${element.vendorId}&IndentEntryId=${element.indentEntryId}&SiteId=${element.siteId}&invoiceDate=${element.strInvoiceDate}&indentType=${indentType}" class="anchor-class">${element.requesterId}</a></td>
				   ...
				   <tfoot>
			        <tr class="info">
			            <td colspan="4" class="text-right subTtl">SUB TOTAL:</td>

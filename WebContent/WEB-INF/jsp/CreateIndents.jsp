    ...
    tableColumnName=tableColumnName.trim();
     ...
     if(tableColumnName == snoColumn) {
    	...
    	if(tableColumnName == productColumn) {
    	    ...
    	    div.setAttribute("class", 'form-control measermentandqty');
    	    cell.appendChild(div);
    	}   	
    		...
    		var div = document.createElement("input");
    	            div.setAttribute("class", "form-control tbl-indent-create measermentandqty");
 ...
 <div class="">
		<form:form modelAttribute="indentCreationModelForm" id="indentCreationFormId" class="form-horizontal">
		   ...
		   <div class="col-md-6">
			...
			<div class="col-md-6">
			 <div class="form-group">
			<label class="control-label col-md-6">Schedule Date :</label>
			<div class="col-md-6" >
				<form:input path="ScheduleDate" id="ScheduleDateId" class="form-control" autocomplete="off"/>
			</div>
		   </div>
			</div>
	  		<div class="col-md-6">
			...
			<div class="col-md-6" >
				<form:input path="RequiredDate" id="RequiredDateId" class="form-control" autocomplete="off"/>
			</div>
			</div>
	   		</div>	
		...
		<thead class="cal-thead-inwards">
  		...
  		<tbody>
				<tr id="chargesrow1">
					...
					<td>
						<form:select path="UnitsOfMeasurement1" id="UnitsOfMeasurementId1" onchange="return validateProductAvailability(this);" class="form-control measermentandqty"/>
					</td>
					<td class="row" >
						
						 <form:input path="Quantity1" id="QuantityId1" onkeypress="return validateNumbers(this, event);" onblur="return validateUnitsAndAvailability(this);" class="form-control tbl-indent-create measermentandqty" autocomplete="off"/>

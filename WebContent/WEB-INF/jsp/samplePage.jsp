 ...
 <div align="center">
		...
		<span style="color:red;">${noStock}</span><br/>
		   <div class="form-group">
			<label class="control-label col-sm-2"><%= reqId%> </label>
			<div class="col-sm-3" >
				<form:input path="ReqId" id="ReqIdId"  name="ReqId" class="form-control"/>
			</div>
			<label class="control-label col-sm-2"><%= date%> <%= colon %> </label>
			<div class="col-sm-3" >
	  		...
	  		<div class="form-group">
				<label class="control-label col-sm-2"><%= requestorName %> <%= colon %>  </label>
				<div class="col-sm-3" >
					<form:input path="RequesterName" id="RequesterNameId"  onkeyup="populateEmployee(this);"  autocomplete="off" class="form-control"/>
				</div>
				<label class="control-label col-sm-2"><%= requestorId %> <%= colon %> </label>
				<div class="col-sm-3" >
	  			...
	  			<div class="form-group">
					...
					<div class="form-group">
					 ...
					 <div class="col-sm-3" >
						<input type="text" id="blockId"  name="blockId" class="form-control" autocomplete="off"/>
					</div>
		  ...
		  <%--  <div class="form-group">
			...
			<div class="col-sm-3" >
						<input type="text" id="flatNumber"  name="flatNumber" class="form-control" autocomplete="off"/>
					</div>	
		...
		<span id="errorMessageInvoiceNumber" style="display:none; color:red">* Already exist the slip number</span>
			...
			<div class="col-sm-3" >
			<%-- 	<form:input path="ContractorName" id="ContractorNameId"  onkeyup="return populateData(this, event);"  autocomplete="off" class="form-control"/> --%>
		...
		<div class="col-md-2 col-md-offset-5 pt-10" >
						<input type="button" class="btn btn-warning" value="Submit" id="saveBtnId" onclick="">
		</div>
	</div>

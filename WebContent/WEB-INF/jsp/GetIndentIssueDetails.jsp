					...
					<div class="right_col" role="main">
						<div class="col-md-12">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active">Get Issue Details</li>
							</ol>
						</div>
						...
						<label class="success text-center center-block"><c:out value="${requestScope['succMessage']}"></c:out> </label> 
						  <form:form  id="indentIssueFormId" action="getIndentViewDts.spring" class="form-horizontal">
							 <div class="col-md-12 border-inwards-box">
								<div class="col-md-6 col-xs-12 col-sm-6 Mrg-bottom">
								 <div class="form-group">
									<label class="control-label col-md-6 col-xs-12 col-sm-6">From Date :</label>
								...
								<div class="col-md-6 col-xs-12 col-sm-6 Mrg-bottom">
									 <div class="form-group">
										<label class="control-label col-md-6 col-xs-12 col-sm-6">To Date :</label>
										<div class="col-md-6 col-xs-12 col-sm-6 input-group">
								...
								<div class="col-md-6 col-xs-12 col-sm-6">
									 <div class="form-group">
										<label class="control-label col-md-6 col-xs-12 col-sm-6">Issue Type :</label>
										<div class="col-md-6 col-xs-12 col-sm-6">
								...
								<div class="col-md-6 col-xs-12 col-sm-6">
									 <div class="form-group">
										<label class="control-label col-md-6 col-xs-12 col-sm-6">Contractor Name :</label>
										<div class="col-md-6 col-xs-12 col-sm-6">
											...
											<input type="hidden" name="moduleName" id="moduleName" value="GetIssueDetails">
										</div>
									</div>
								</div>
							    <div class="col-md-6 col-xs-12 col-sm-6">
								...
								%>
								<label class="control-label col-md-6 col-xs-12 col-sm-6">Site :</label> 
								<div class="col-md-6 col-xs-12 col-sm-6">
								<%
					   ...
					   <div class="table-responsive Mrgtop20 dragscroll">
						  <table id="tblnotification"	class="table table-new" cellspacing="0" style="">
							  <thead>
								<tr>
									<th>S NO</th>
									<th>Issued Date</th>
									<th>Requester ID</th>
				    				<th>Slip Number</th>
				    				<th>Contractor Name/Vendor Name</th>
				    				<!-- <th>Floor Id</th> -->   
				    			</tr>
							  </thead>
							<tbody>
							<c:forEach items="${indentIssueData}" var="element">  
							   <tr>
									...
									<td> <c:if test="${element.contractorName eq '-'}">${element.vendorName }</c:if>
										<c:if test="${element.contractorName ne '-'}">${element.contractorName }</c:if>

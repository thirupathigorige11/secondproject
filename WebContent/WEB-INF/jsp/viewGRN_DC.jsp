    ...
    <table class="table table-bordered">
        <tbody>
            ...
            <tr>
                ...
                <td class="text-left width85 verticalbott pbl0">Project Name</td><td colspan="5"><%= session.getAttribute("SiteName") %></td>
            ...
            <tr>
                ...
                <td colspan="3" class="text-right verticalbott pbr0">DC Date</td><td colspan="5"><%=dcDate%></td>
            </tr>
            <tr>
                <td colspan="3" class="text-left">GSTIN No</td><td><%=gstinNumber%></td>
                <td class="text-left verticalbott pbl0">Invoice No</td><td colspan="5"></td>
                <td colspan="3" class="text-right verticalbott pbr0">Invoice Date</td><td></td>
            </tr><tr>
...
<!--             <tr>
            ...
            <% 
           	...
           	<% 	} %>           
                ...
                <td colspan="12" class="text-right totalamt"> Total</td><td><%= fnlAmnt %></td><td></td>
	    	             ...
	    	             <tr>
                <td></td><td></td>
                <td colspan="12" class="text-right totalamt"><font size="2">Round Off</font></td><td><%= roundoff %></td><td></td>
                
            </tr>
                     <tr>
                <td></td><td></td>
                <td colspan="12" class="text-right totalamt">Gross Total</td><td><%= grandtotal %></td><td></td>
	      ...
	      <tr rowspan="4">
               <td colspan="6" class="br0 ht150 verticalbott text-center pb0"><span class="pre-class" style="padding: 20px;font-weight: bold;">Prepared By:</span><span class=bacend-content"><%=strUserName%>  <%=strcurrentDateAndTime%></span> </td> <td colspan="6" class="br0 bl0 pb0 verticalbott text-center">Checked By</td> <td colspan="4" class="bl0 pb0 text-center verticalbott">Approved By</td> 
            </tr>
        </tbody>
    </table>
    
        
       <!--  <button onclick="myFunction()" id="printpage" class="btn btn-warning" style="width: 110px; height: 28px;margin-left: 591px;background: #b3b5f">Print</button> -->

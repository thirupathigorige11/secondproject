      ...
      <div class="col-sm-offset-2 col-sm-10">
        ...
        <div style="margin-top: 36px">${displayErrMsg}</div>
				...
				<tr>
					...
					<td><a href="getInvoiceDetails.spring?invoiceNumber=${element.requesterId}&vendorName=${element.vendorName}" style="text-decoration: underline;color: blue;">${element.requesterId}</a></td>
					
					<td style="color: black;">${element.vendorName}</td>
					
					<td style="color: black;">${element.strInvoiceDate}</td>
					
					<td style="color: black;">${element.strTotalAmount}</td>
				</tr>
				</c:forEach>
				</tbody>
					</table>

...
<div class="">
		<div class="" style="display: inline-block;width: 41%;text-align: center;font-size: 22px;font-weight: bold;border: 2px solid black;float: left;margin-top: 6px; height: 137px;margin-left: 26px;margin-right: -1px;"><span style="display:inline-block;margin-top:35px;">Purchase Order</span></div>
...
<%   
    ...
    <table style="border:1px solid #000;font-family: Calibri;    font-weight: bold;margin-top: 98px;width: 1050px;;margin-left: 20px;">
      ...
      <tr class="bckcolor">
        ...
        <% } } %>
	                ...
	                <tr>
                <td></td><td></td><!-- <td></td> -->
                <td style="font-size: 16px;font-weight: bold;" colspan="10" class="text-right totalamt"> Total</td><td></td><!-- <td></td><td></td> --><td style="font-size: 16px;font-weight: bold;"><%=finamount %></td>
...
<div class="col-md-12">
 ...
 <%} %>
 		...
 		<!-- /*code for iframe pdf*/ -->
				...
				<%-- </form:form> --%>
    <button onclick="myFunction()" class="btn btn-warning" id="printpage" style="">Print</button>

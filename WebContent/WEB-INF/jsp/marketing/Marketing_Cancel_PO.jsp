				...
				<div class="right_col" role="main">
					<div class="col-md-12">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active">Modify Temp PO</li>
						</ol>
					</div>
					<div>
	<div class="col-md-12">
		   ...
		   <div class="border-indent"> <!-- container -->
			...
			<div class="col-md-12">
				...
				<div class="col-md-6 col-xs-12" >
					...
					<input type="hidden" id="poEntryId"  name ="poEntryId"  class="form-control" value="${oldPOEntryId}"/>
					<input type="hidden" id="oldPODate"  name ="oldPODate"  class="form-control" value="${oldPODate}"/>
					<input type="hidden" id="toSiteId" name="siteId" class="form-control" readonly="true" value="${poDetails.site_Id}"/>
					 ...
					 <input type="hidden" id=oldPoNumber" name="oldPoNumber" class="form-control" readonly="true" value="${poDetails.edit_Po_Number}">
			     </div>
			</div>
			</c:forEach>
	</div>
  ...
  <div class="control-group" id="fields">
     ...
     <c:forEach items="${listTermsAndCondition }" var="item">
      ...
      <button type="button" class="btn-danger remove-button remove_field" ><i class="fa fa-remove "></i></button>
       ...
       <script src="js/marketing/MarketingCancelPODetails.js" type="text/javascript"></script>
			   ...
			   $("#others-divMp").hide();
			 	...
			 	function createPO() {
					...
					$(".loader-ims").show();
			 		...
			 		document.getElementById("doInventoryFormId").action ="updateMarketingTempPoPage.spring";

	...
	<div class="container body" id="mainDivId">
				...
				<div id="mydiv" class="hide-show-iframe">
					...
					<div class="col-md-12" id="hide-show-iframe">
						...
						<div class="body-invoice-payment">
							<form class="form-horizontal" action="IntiatePayment.spring">
								<div class="col-md-12 col-xs-12 col-sm-12">
									...
									<div class="col-md-6 col-xs-12">
  									...
  									<div class="clearfix"></div>
  									<div class="col-md-6 selectAllchk">
  									
									  <input type="checkbox" class="selectAllchkinput" id="paymentReqDateCheck" name="paymentReqDateCheck" value="" /> <label class="control-label"> No of Days for Payment after Delivery Applicable</label>
									  <input type="hidden" id="hiddenpaymentReqDateCheck" name="hiddenpaymentReqDateCheck" value="" />
									
									</div>
									<div class="clearfix"></div>
  									<div class="col-md-6 col-xs-12 Mrgtop10">
										<div class="form-group">
											<label class="col-md-5 col-xs-12 control-label"><strong>Payment Requested Date From:</strong></label>
											<div class="col-md-6 col-xs-12 input-group">
												<input type="text" class="form-control control-text-height readonly-color"
													id="paymentReqDatefrom" name="paymentReqDatefrom"
													value="${paymentReqDatefrom}" autocomplete="off" readonly="true"/>
													<label class="input-group-addon btn" for="paymentReqDatefrom"> <span class="fa fa-calendar"></span> </label>
											</div>
										</div>
									</div>
									<div class="col-md-6 col-xs-12 Mrgtop10">
										<div class="form-group">
											<label class="col-md-5 col-xs-12 control-label"><strong>Payment Requested Date To:</strong></label>
											<div class="col-md-6 col-xs-12 input-group">
												<input type="text" class="form-control control-text-height readonly-color"
													id="paymentReqDateto" name="paymentReqDateto"
													value="${paymentReqDateto}" autocomplete="off" readonly="true"/>
													<label class="input-group-addon btn" for="paymentReqDateto"> <span class="fa fa-calendar"></span> </label>
											</div>
										</div>
									</div>
									<div class="clearfix"></div> 
						...
						<form class="form-horizontal" id="paymentIntiateFormId">
							<c:forEach items="${listTotalInvoices}" var="element">
									...
									<div class="col-md-12">
											...
											<div class="form-group">
												...
												<div class="col-md-5 col-lg-6">
													<div class="col-md-10 no-padding-left">
														<span><a href="${INVOICEPATH}invoiceNumber=${element.strInvoiceNo}&vendorName=${element.strVendorName}&vendorId=${element.strVendorId}&IndentEntryId=${element.intIndentEntryId}&SiteId=${element.strSiteId}&invoiceDate=${element.strInvoiceDate}" target="_blank" class="" style="color:blue;font-weight:bold;word-break: break-word;">${element.strInvoiceNo}</a></span>
													</div>
													<div class="col-md-2 no-padding-right">
														<c:if test="${element.hasImage}">
														<span style="float: right;" href="#" onclick="SetPageImage('${INVOICEPATH}invoiceNumber=${element.strInvoiceNo}&vendorName=${element.strVendorName}&vendorId=${element.strVendorId}&IndentEntryId=${element.intIndentEntryId}&SiteId=${element.strSiteId}&invoiceDate=${element.strInvoiceDate}&imageClick=true')" class="ponumber-anchor" ><i	class="fa fa-file-image-o check-image"></i></span>
														</c:if>
													</div>
												</div>
											</div>
										...
										<div class="col-md-6 col-lg-4">
											<div class="form-group">
												...
												<div class="col-md-5 col-lg-6">
													<p class="color-blue">
													<a style="text-decoration: underline;color:blue;word-break: break-word;" href="#" onclick="SetPageImage('${POPATH}poNumber=${element.strPONo}&siteId=${element.strSiteId}&imageClick=true')" class="ponumber-anchor" >${element.strPONo}</a>
													</p>
												</div>
											</div>
										</div>
										...
										<div class="col-md-6 col-lg-4">
											<div class="form-group">
												<label class="col-md-7 col-lg-6">Payable Invoice Amount :</label>
												<div class="col-md-5 col-lg-6">
													<p class="color-blue">
										...
										<div class="col-md-6 col-lg-4">
											<div class="form-group">
												<label class="col-md-7 col-lg-6">Till Req Amount :</label>
												<div class="col-md-5 col-lg-6">
													<p style="color:blue;">
										...
										<div class="col-md-6 col-lg-4">
											<div class="form-group">
												<label class="col-md-7 col-lg-6">Credit Note Number :</label>
												<div class="col-md-5 col-lg-6">
													<p class="color-blue">
										...
										<div class="col-md-6 col-lg-4">
											<div class="form-group">
												<label class="col-md-7 col-lg-6">Payment Req Date :</label>
												<div class="col-md-5 col-lg-6 input-group">
													<input type="text" class="form-control control-text-height datepicker-paymentreq-class readonly-color"
														name="PaymentreqDateId${element.intSerialNo}"  value="${element.strPaymentReqDate}"  id="PaymentreqDateId${element.intSerialNo}" autocomplete="off" required="required" readonly="true"/>
										...
										<div class="col-md-6 col-lg-4">
											<div class="form-group">
												...
												<div class="col-md-5 col-lg-6">
													<input type="text" class="form-control control-text-height" name="AmountToBeReleased${element.intSerialNo}" id="AmountToBeReleased${element.intSerialNo}" onblur="validateAmountToBeRelease(${element.intSerialNo})" onkeypress="return isNumberCheck(this, event)" required="required"/>
												</div>
											</div>
										</div>
										<div class="col-md-6 col-lg-4">
											<div class="form-group">
												<label class="col-md-7 col-lg-6">Adjust Amount form Advance :</label>
												<div class="col-md-5 col-lg-6">
													<input type="text" class="form-control control-text-height" name="AdjustAmountFromAdvance${element.intSerialNo}" id="AdjustAmountFromAdvance${element.intSerialNo}" value="${element.doubleAdjustAmountFromAdvance}" onblur="validateAdjustamountformadvance(${element.intSerialNo})" onkeypress="return isNumberCheck(this, event)"/>
												</div>
											</div>
										</div>
										<div class="col-md-6 col-lg-4">
											<div class="form-group">
												<label class="col-md-7 col-lg-6">PO Advance :</label>
												<div class="col-md-5 col-lg-6">
													<p>
										...
										<div class="col-md-6 col-lg-4">
											<div class="form-group">
												<label class="col-md-7 col-lg-6">Security deposit at vendor :</label>
												<div class="col-md-5 col-lg-6">
													<p>
										...
										<div class="col-md-6 col-lg-4">
											<div class="form-group">
												<label class="col-md-7 col-lg-6">Note :</label>
												<div class="col-md-5 col-lg-6">
										...
										<div class="col-md-6 col-lg-4">
											<div class="form-group">
												<label class="col-md-7 col-lg-6">Total Invoice Amount :</label>
												<div class="col-md-5 col-lg-6">
													<p>
								...
								<input type="hidden" name = "paymentRequestedOnPO${element.intSerialNo}"  value = "${element.paymentRequestedOnPO}">
								<!-- Hidden Fields End -->
		...
		$(document).ready(function() {
			...
			$(function() {
				...
				$("#paymentReqDatefrom").datepicker({
					changeMonth: true,
				    changeYear: true,
					dateFormat : "dd-M-y",					
					onSelect: function(selected) {
		     	        $("#paymentReqDateto").datepicker("option","minDate", selected)
		     	        }
				});
				$("#paymentReqDateto").datepicker({
					changeMonth: true,
				    changeYear: true,
					dateFormat : "dd-M-y",
					onSelect: function(selected) {
		            	$("#paymentReqDatefrom").datepicker("option","maxDate", selected)
		            	        }
				});
			});
			/*script for datepickers*/

				...
				<div class="loader-sumadhura" style="display: none;z-index:999;">
					...
					<div class="col-md-12">
						<div class="container container-viewmypayment-box-1">
							 ...
							 <form class="form-horizontal"  action="viewSiteWiseTransactionDetails.spring" style="margin-top: 30px;">
							   <div class="col-md-12">
							     <div class="col-md-6 Mrgtop10">
								     <div class="form-group">
									      <label for="date" class="col-md-6 col-xs-12"><strong>Payment Done From  :</strong></label>
										  <div class="col-md-6 col-xs-12 input-group"> <input type="text" id="ReqDateId1" class="form-control readonly-color" name="fromDate" value="${fromDate}" autocomplete="off" readonly="true">
							  	 ...
							  	 <div class="col-md-6 Mrgtop10">
								  	 <div class="form-group">
									    <label for="todate" class="col-md-6 col-xs-12">Payment Done To  :</label>
							  	...
							  	<div class="col-md-6">
								  	<div class="form-group">
								       <label for="invoiceNumber" class="col-md-6 col-xs-12">Invoice Number :</label>
							  	...
							  	<div class="col-md-6">
								  	 <div class="form-group">
								  	  <label class="col-md-6 col-xs-12">Site/Department :</label> <!-- removed class commlbl  -->
									  <div class="col-md-6 col-xs-12">

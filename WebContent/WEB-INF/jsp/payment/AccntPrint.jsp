...
<% if(Integer.parseInt(request.getAttribute("listTotalPaymentReqSize").toString())==0){
	...
	%>
	<center><font color="red" size="5"><span id="refresh_msg"><c:out value="No Approvals Done"></c:out></span> </font></center>
	<% }
else{
	%>
			...
			<!-- <div class="loginbox">
					<div style="border: 0;" class=" nav_title">
								<a class="site_title" href="PaymentApprovalForAccDept.spring">Back</a>
				</div>
			</div> -->
...
<%--               <tr>
         ...
         <tr class="bckcolor">
                ...
                <td class="text-left">Vendor Name</td> 
                 ...
                 <td  class="text-left" style="width:200px">Invoice Number</td> 
                <td  class="text-left">PO Date</td> 
                <td  class="text-left">PO Number</td> 
                <td  class="text-left" style="width:230px">PO Amount</td> 
                <td  class="text-left" style="width:230px">Invoice Amount</td> 
    			 <td  class="text-left" style="width:230px">Paid Amount</td> 
    			  ...
    			  <td  class="text-left" style="width:230px">Requested Amount</td> 
    			   <td  class="text-left" style="width:230px">Payment Against</td> 
            ...
            <c:forEach items="${listofPendingPayments}" var="element">  
                ...
                <td class="text-left">${element.strVendorName} </td> 
                 <td  class="text-left">${element.strInvoiceDate} </td> 
                 <td  class="text-left" style="width:200px">${element.strInvoiceNo} </td> 
                <td  class="text-left">${element.strPODate} </td> 
                <td  class="text-left">${element.strPONo} </td> 
                <td  class="text-left" style="width:230px">${element.strPOAmount} </td> 
    			<td  class="text-left" style="width:230px">${element.strInvoiceAmount} </td> 
    			 <td  class="text-left" style="width:230px">${element.doublePaidAmount}</td> 
    			  <td  class="text-left" style="width:230px">${element.balanceAmt} </td> 
    			  <td  class="text-left" style="width:230px">${element.requestedAmount} </td> 
    			  <td  class="text-left" style="width:230px">${element.paymentType.equals("DIRECT")?"Invoice":"PO"} </td> 
...
<form:form action="generatePaymentTextFile.spring" name="generatefile" id="generatefile" method="get" onSubmit="JavaScript:disableRefreshDetection()">
<input type="hidden" name="generateFileifTrue" value="true">
<input type="hidden" id="refreshed" value="no">
</form:form>
</div>
 <div style="text-align:center;">
  <button onclick="myFunction()" id="printpage" class="btn btn-warning" style="color: #fff;background-color: #f0ad4e;border-color: #eea236;padding: 10px 20px;border-radius:5px;border:1px solid #eea236;">Print</button>
 </div>   		
    		<!-- jQuery -->

				...
				<div id="mydiv" class="hide-show-iframe">
					<div>
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active">Payment Approval Site
								Level</li>
						</ol>
					</div>
					...
					<div id="payements_container">
									...
									<div class="form-group">
										...
										<div class="col-md-6 no-padding-left no-padding-right">
											<select id="modeofpayment1<%=element.getContractorGroupSerialNo()%>" class="form-control1 "
												...
												name="paymentModeGroup<%=element.getIntSerialNo()%>">
						...
						<div align="" class="formShow" style="display: none;">
							<div id="PaymentsShowData" class="Mrgtop20">
								...
								<div class="form-horizontal">
									...
									<div class="col-md-3 Mrg-bottom">
										  <div class="form-group">
											...
											<div class="col-md-6">
											  <select
													class="form-control sectionModeOfPayment<%=element.getContractorGroupSerialNo()%>"
													style="border: 1px solid black;"
													name="paymentMode<%=element.getIntSerialNo()%>" id="paymentMode<%=element.getIntSerialNo()%>" >
									...
									<div class="col-md-3 Mrg-bottom">
										 <div class="form-group">
											...
											<div class="col-md-6">
											<div><strong><a class="anchor-invoice"
									...
									<div class="col-md-3 Mrg-bottom">
										<div class="form-group">
											...
											<div class="col-md-6">
											<input style="border: none; color: blue;" type="text" class=""
									...
									<div class="col-md-3 Mrg-bottom">
										<div class="form-group">
											<label for="" class="col-md-6">UTR No / Cheque No:</label>
											 <div class="col-md-6">
											   <input style="color: #2dcc10; border: none;"
												name="utrOrChqNo<%=element.getIntSerialNo()%>" class=""
												autocomplete="off" placeholder="Enter here" value="<%=element.getUtrChequeNo()%>" />
											</div>
										</div>
									</div>
									<div class="clearfix"></div>
									...
									<div class="col-md-3 Mrg-bottom">
										<div class="form-group">
											...
											<div class="col-md-6">
											<input style="color: #2dcc10; border: none;" type="text" class="price<%=element.getContractorGroupSerialNo()%> "
												...
												name="requestAmount<%=element.getIntSerialNo()%>" readonly />
										   </div>
										</div>
									</div>
									<div class="col-md-3 Mrg-bottom">
									...
									<div class="col-md-3 Mrg-bottom">
										<div class="form-group" >
											...
											<div class="col-md-6"><input
												...
												value="<%=element.getStrPaymentReqDate()%>" readonly="true" />
											</div>
										</div>
									</div>
									<div class="col-md-3 Mrg-bottom">
										<div class="form-group">
											...
											<div class="col-md-6">
											  <input style="border: none; word-wrap: break-word;" type="text" placeholder="Enter here"
									...
									<div class="col-md-3 Mrg-bottom">
									 <div class="form-group">
										...
										<div class="col-md-6">
										 <input id="remarks" style="border: none; width:100px;word-wrap: break-word;"class=""
								...
								<input type="hidden" name="cntPaymentId<%=element.getIntSerialNo()%>" id="cntPaymentId<%=element.getIntSerialNo()%>" value="<%=element.getIntCntPaymentId()%>">
								<input type="hidden" name="tempPaymentTransactionId<%=element.getIntSerialNo()%>" value="<%=element.getIntTempPaymentTransactionId()%>">
								...
								<input type="hidden" name="billNumber<%=element.getIntSerialNo()%>" value="<%=element.getBillNumber()%>">
								<input type="hidden" name="billAmount<%=element.getIntSerialNo()%>" value="<%=element.getDoubleBillAmount()%>">
								<input type="hidden" name="billDate<%=element.getIntSerialNo()%>" value="<%=element.getStrBillDate()%>">
			...
			<c:when test="${not empty showGrid}">
				<div class="btn-submit col-md-12 text-center center-block">
					<button class="btn btn-warning  "
						id="btn-submitt" type="button"  onclick="return validateformData()" 
						style="margin-top: 21px; margin-bottom: 20px;">SUBMIT</button>
				</div>
			</c:when>
			<c:otherwise>
...
$('#myframe').load(function () {
	...
	function validateRowData() {debugger;
		...
		for (i = 1; i <= noOfRecords; i++) { 					
			...
			cntPaymentId = $('#cntPaymentId'+i).val();//cntPaymentId
	     
			if(statusSitelevel1 == 'Approved' && paymentMode == ''){
		          alert("Please select Mode Of Payment for Payment Details ID: "+cntPaymentId);
	...
	function validateformData(){
      ...
      document.getElementById("paymentApprovalform").action = "updateCntAccDeptPaymentTransaction.spring";

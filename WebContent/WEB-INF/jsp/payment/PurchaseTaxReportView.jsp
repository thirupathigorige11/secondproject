			...
			<div class="right_col" role="main">
				<div id="mydiv" class="hide-show-iframe">
					...
					<center><label class="success"><c:out value="Click below button to download table data in Excel"></c:out> </label></center> 
				     			...
				     			<input type="hidden" name="invoiceFromDate"  value="${invoiceFromDate}" />
								<input type="hidden" name="invoiceToDate"  value="${invoiceToDate}" />
								<input type="hidden" name="grnFromDate"  value="${grnFromDate}" />
								<input type="hidden" name="grnToDate"  value="${grnToDate}" />
...
<td>${element.amountPerUnitBeforeTaxes}</td>

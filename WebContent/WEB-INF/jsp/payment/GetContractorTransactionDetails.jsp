...
<label class="success"><c:out value="${requestScope['succMessage']}"></c:out> </label> 
	...
	<form class="form-horizontal"  action="viewMyContractorTransactionDetails.spring" style="margin-top: 30px;"  >
...
<div class="loader-purchase" style="display: none;">
		...
		<tr class="info">
            <td colspan="3" class="text-right subTtl" style="display:none;">SUB TOTAL:</td>

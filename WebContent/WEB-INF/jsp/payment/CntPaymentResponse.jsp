...
<form onSubmit="JavaScript:disableRefreshDetection()">
 ...
 <center><font color="red" size="5"><span id="refresh_msg"></span></font></center>
 


<center><font color="red" size="5"><span id="msg1"><c:out value="${requestScope['message1']}"></c:out> </span></font></center>

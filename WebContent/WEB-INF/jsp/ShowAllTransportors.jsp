...
<title>View Transportor Master</title>
</c:if>
<c:if test="${isContractorEditable!=false}">
				...
				<div>
					<ol class="breadcrumb">
						<li class="breadcrumb-item"><a href="#">Masters</a></li>
												<c:if test="${isTransportorEditable==false}">
					
					<li class="breadcrumb-item active">View Transportor</li>
						</c:if>
						<c:if test="${isTransportorEditable!=false}">
					<li class="breadcrumb-item active">Update/Delete Transportor Details</li>
						</c:if>
...
<div class="table-responsive">
	<table id="transportorTableData" class="table table-striped table-bordered " cellspacing="0">
	<thead>
						<tr>
							<th><strong>Transportor Name</strong></th>
...
<c:forEach items="${transportorList}" var="item">
						<tr>
							<td><a href="getTransportorDetails.spring?transportorId=${item.contractor_id}&isTransportorEditable=${isTransportorEditable}"> ${item.contractor_name} </a></td>
							<td>${item.address}</td>
	...
	<script>
		...
		$(document).ready(function() {
			...
			$(".up_down").click(function() {
				...
				$('#transportorTableData').DataTable();
			});

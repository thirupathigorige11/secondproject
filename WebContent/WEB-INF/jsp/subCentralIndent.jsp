		...
		<span style="color:red;">${noStock}</span><br/>
			...
			<div class="col-sm-3" >
				<select  id="site_id"  name="site_id"  class="form-control">
								...
								<option  value="103">LAKEBREAZEL</option>
								<option  value="104">SILVEREPILES</option>
								<option  value="105">SOHAM</option>
								<option  value="107">EDEN GARDENS</option>
						</select>	
			</div>
		   </div>
...
<c:forEach items="${list}" var="indent">
				<tr>				
					...
					<td>Housekeeping Material</td>
					<td>Acid</td>
					<td>Anandam 200 <br> Lake Breeze2</td>	
			...
			<div class="row"> <!-- tblindentissunote -->
				...
				<div class="col-sm-2 pt-10">
					<a class="site_title" href="subCentralIndent.spring"><input type="button" class="btn btn-warning" value="Submit" onclick="saveRecords('SaveClicked')" id="saveBtnId" ></a>
					</div>
...
<script src="js/custom.js"></script>
  <script>
			...
			$("#sttle-id").click(function(){debugger;

		...
		<div class="main_container" id="main_container">
			...
			<div class="right_col" role="main">
				...
				<tr>
					...
					<td><a href="viewPurchaseIndent.spring?indentNumber=${element.indentNumber}&siteName=${element.siteName}" style="text-decoration: underline;color: blue;">${element.indentNumber}</a></td>

           ...
           <center><span><font color=green size=4 face="verdana">${responseMessage}</font></span></center>
			...
			<thead >
  			...
  			<tr>
  					...
  					<td>${boqData.materialTotalQuantity }</td>
  					<td id="totalAmount" class="totalAmountCls">${boqData.materialTotalAmount }</td>
			...
			<tbody>
			     <tr class="info">
					 <td colspan="7" class="text-right subTtl">SUB TOTAL:</td>
					 <td id="qtyTotal"></td>
					 <td></td>
					 <td></td>
					 <td></td>
				...
				<br><br><a href="getBOQDetailsSelection.spring?BOQSeqNo=${ObjBOQDetails.strBOQSeqNo}&siteId=${ObjBOQDetails.strSiteId}&pageHighlightURL=${pageHighlightURL}"  class="btn btn-warning">Back To BOQ Main Page</a>
				<br><br>
			</div>
           </div>
				<!-- /page content -->

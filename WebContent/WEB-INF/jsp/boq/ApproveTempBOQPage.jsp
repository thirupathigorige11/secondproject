 ...
 <div class="col-md-12">
	...
	<!-- TABLE -->
					  ...
					  <div class="clearfix" ></div>
										<table id="example"	class="table table-striped table-bordered st-table"  cellspacing="0">
											...
											<tbody>
												...
												<c:forEach var="boqMainList" items="${requestScope['boqData']}">
													<tr>
														<td><a class="anchor-class" href="getTempMinorHeads.spring?tempBOQNo=${boqMainList.intTempBOQNo}&siteId=${boqMainList.strSiteId}&boqType=${boqMainList.boqType}&majorHeadId=${element.strMajorHeadId}&viewTempBoq=${viewTempBoq}&pageHighlightURL=${pageHighlightURL}"  title="Click on the product name to see the details">${element.strMajorHeadDesc}</a>  </td>
			...
			<c:if test="${ not viewTempBoq}">
				...
				<a href="downloadBOQ.spring?tempBOQNo=${ObjBOQDetails.intTempBOQNo}&siteId=${ObjBOQDetails.strSiteId}&siteName=${ObjBOQDetails.strSiteName}&temporaryBOQ=true"  class="btn btn-warning" >DOWNLOAD BOQ</a>
				</c:forEach>	

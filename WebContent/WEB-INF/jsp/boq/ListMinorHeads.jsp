...
@media (max-width: 800px){.dataTables_paginate {display: block !important;}}
...
<!-- DropDown Options - start -->
				...
				<div class="table-responsive" >
					<table id="example"	class="table display table-fixed-header" cellspacing="0" style="width:100%;">
						<thead>
							<tr>
								<th>Major Head</th>
						...
						<tbody>
							<c:forEach items="${minorHeadsDetails}" var="element">
								<tr>
									...
									<td><a class="anchor-class" href="getBOQDetails.spring?BOQSeqNo=${ObjBOQDetails.strBOQSeqNo}&combobox_Product=${element.strMajorHeadId}&combobox_SubProduct=${element.strMinorHeadId}&pageHighlightURL=${pageHighlightURL}"  title="Click on the product name to see the details">${element.strMinorHeadDesc}</a>  </td>
   ...
   <script src="js/bootstrap.min.js"></script>
	...
	<script>
		$(document).ready(function() {
					...
					$('.anchor-class, .anchor-click').click(function(){

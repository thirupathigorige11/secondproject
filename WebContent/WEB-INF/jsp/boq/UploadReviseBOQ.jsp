			...
			<div class="right_col" role="main">
				<div>
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">Upload Revise BOQ</li>
					</ol>
				</div>
				...
				<div class="col-md-12">
					<div class="container border-inwards-box">
						...
						<form class="form-horizontal" action="SaveReviseBOQ.spring" method="POST"  enctype="multipart/form-data">
							 	<!-- Site Selection START -->
							 	              <div class="col-md-4 col-md-offset-4 col-sm-9 col-sm-offset-2">
											    ...
											    <div class="col-md-12 col-sm-12"><div class="form-group">
														...
														<div class="col-md-7 col-sm-4"><select id="dropdown_SiteId" name="dropdown_SiteId" onchange="setSiteId()" 
														class="custom-combobox form-control">
														</select></div>
	 					    						</div></div>
	 					    						</c:if>
											     <div class="col-md-12 col-sm-12">
											      <div class="form-group">
										         <label for="todate" class="col-md-5 col-sm-4 text-left">Upload Revise BOQ :</label>

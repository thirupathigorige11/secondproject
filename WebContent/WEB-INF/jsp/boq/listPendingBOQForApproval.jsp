...
<body class="nav-md">
				 ...
				 <c:if test="${showSiteSelection}">
					<div class="col-md-12 border-inwards-box">
					 <div class="col-md-8 col-md-offset-2">
					  <form class="form-inline" name="myForm" action="getSiteWisePendingForApprovalBOQList.spring"> 
	...
	<script>
		...
		function ApprovalBOQDetails(TempBOQNo, SiteId, boqType, serialNo, type, pageHighlightURL){debugger;
		    ...
		    if(type=="revise"){
		    	window.location.href="getPendingForApprovalReviseBOQMajorHeads.spring?tempBOQNo="+TempBOQNo+"&siteId="+SiteId+"&boqType="+boqType+"&pageHighlightURL="+pageHighlightURL+"&viewTempBoq=";
		    }else{
		    	window.location.href="getPendingForApprovalBOQDetails.spring?tempBOQNo="+TempBOQNo+"&siteId="+SiteId+"&boqType="+boqType+"&pageHighlightURL="+pageHighlightURL+"&viewTempBoq=";
		    }

...
.img-table-getinvoice{width:100%;}
.pdf-cls {
    position: relative;
    width: 100%;
	margin:auto;
...
%>
			 <div class="col-md-3 pdfcount pdf-delete<%=i%>">
			  ...
			  <iframe class="iframe-pdf" src="${requestScope[pdfBase64]}" allow="fullscreen" style="height:500px;width:100%;border:1px solid #000;"></iframe>
			  <%-- <div class="middle">

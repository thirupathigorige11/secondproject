...
@media print {
	.viewQuote,.print-hide,#IMAGEView,#PDFView{
		display: none;
	}
	.anchor-description{text-decoration:none;}
	.printTable{width:100% !important;margin-left:0px !important;}
...
@media print {
	...
	html, body, div, span, ol li, span,  applet, object, iframe, h1, h2, h3, h4, h5, h6, p, blockquote, pre, a, abbr, acronym, address, big, cite, code, del, dfn, em, font, ins, kbd, q, s, samp, small, strike, strong, sub, sup, tt, var, dl, dt, dd, ol, ul, li, fieldset, form, label, legend, table, caption, tbody, tfoot, thead, tr, th, td {
           font-size: 10px !important;
	  }
	  .printTabletd, .spanclass{
	  	font-size: 10px !important;
	  }
	/* div{
...
" id="tableStyle">
 <tbody>
	<tr>
	  <td rowspan="3" class="purchoseOrder" style="
    width: 30%;font-size:14px;font-weight:bold;border: 2px solid #000;
">Purchase Order</td>
	  <td style="
    width: 25%;font-size:14px;font-weight:bold;padding: 5px;border: 2px solid #000;
" class="printCls">Version No:</td>
	  <td style="
    width: 25%;font-size:14px;font-weight:bold;padding: 5px;border: 2px solid #000;" class="printCls">${requestScope['versionNo']}</td>
	  <td rowspan="3" style="
    width: 20%;
    borer: non;
    border: 1px solid #fff !important;
"><img src="images/LOGO_ISO.png"></td>
	</tr>
	<tr>
	  <td style="width:25%;font-size:14px;font-weight:bold;padding: 5px;border: 2px solid #000;" class="printCls">Issue Date:</td>
	  <td style="width:25%;font-size:14px;font-weight:bold;padding: 5px;border: 2px solid #000;" class="printCls">${requestScope['strPoPrintRefdate']}</td>
	</tr>
	<tr>
	  <td style="width:25%;font-size:14px;font-weight:bold;padding: 5px;border: 2px solid #000;" class="printCls">Refference Number:</td>
	  <td style="width:25%;font-size:14px;font-weight:bold;padding: 5px;border: 2px solid #000;" class="printCls">${requestScope['refferenceNo']}</td>
	</tr> 
 </tbody>
</table>
...
<%-- <div style="width:100%;">
    ...
    width: 30%;text-align: center;font-size: 22px;font-weight: bold;border: 1px solid black;float: left;margin-top: 6px;height: 137px;margin-left: 0px;padding-top:50px;">Purchase Order</div></div>
		...
		<!-- <div  style="display: inline-block; width: 20%;">			
				<img class="text-responsive" style="float: right; right: 94px;    width: 150px;" src="images/LOGO_ISO.png" />
		</div> -->
	 <% 
	...
	<div style="width:100%;margin-top:40px;">
	 	<div style="width:60%;float:left;">
	 		<span style="width:25%;vertical-align:middle;display: table-cell;float:left;font-size: 16px;font-weight: bold;font-family: Calibri;">PO Ref No</span>
			<span style="width:2%;vertical-align:middle;display: table-cell;float:left;font-family: Calibri;">:</span>
			<span style="width:65%;display:inline-block;font-family: Calibri;"> <%=strPONumber%> </span><br>
	 	</div>
	  <%-- <%if(strResponse.equalsIgnoreCase("true")){ %> --%>
	 	<div style="width:40%;float:left;">
	 		<span style="width:30%;display:inline-block;font-size: 16px;font-weight: bold;font-family: Calibri;">Indent No</span>
			<span style="width:2%;display:inline-block;font-family: Calibri;">:</span>
			<span style="width:60%;display:inline-block;font-family: Calibri;"><%=siteWiseIndentNo%></span> 
	 	</div>
	 </div>
	 <%-- <% } %> --%>
	 <div style="width:100%;margin-bottom:40px;">
	 	<div style="width:60%;float:left;">
	 		<span style="width:25%;vertical-align:middle;display: table-cell;float:left;font-size: 16px;font-weight: bold;font-family: Calibri;">PO Date</span>
			<span style="width:2%;display:inline-block;font-family: Calibri;float:left;">:</span>
			<span style="width:65%;display:inline-block;font-family: Calibri;"><%=reqDate%></span>
	 	</div>
	 	 <%-- <%if(strResponse.equalsIgnoreCase("true")){ %>  --%>
	 	<div style="width:40%;float:left;">
	 	    <span style="width:30%;display:inline-block;font-size: 16px;font-weight: bold;font-family: Calibri;">Indent Date</span>
			<span style="width:2%;display:inline-block;font-family: Calibri;">:</span>
			<span style="width:60%;display:inline-block;font-family: Calibri;"><%=creationDate%></span>	 	
	 	</div>
	 <%-- <%} %> --%>
	 </div>
	 <%} else{%>
	 <div style="margin-top:40px;">
	 	<div style="width:100%;float:left;">
	 		<span style="width:15%;vertical-align:middle;display: table-cell;float:left;font-size: 16px;font-weight: bold;font-family: Calibri;">PO Ref No</span>
			<span style="width:2%;vertical-align:middle;display: table-cell;float:left;font-family: Calibri;">:</span>
			<span style="width:83%;display:inline-block;font-family: Calibri;"> <%=strPONumber%> </span><br>
	 	</div>	
	 	<div style="width:100%;">
	 		<span style="width:15%;vertical-align:middle;display: table-cell;float:left;font-size: 16px;font-weight: bold;font-family: Calibri;">PO Date</span>
			<span style="width:2%;display:inline-block;font-family: Calibri;float:left;">:</span>
			<span style="width:83%;display:inline-block;font-family: Calibri;"><%=reqDate%></span>
	 	</div>	 	
	 </div>
	 <%} %>
	<%-- <div class="bAddress" style="    margin-top: 28px;">
		<div class="header-content2"
			style="margin-bottom: 21px; font-size: 16px; font-family: Calibri; width: 414px;; height: 118px; margin-top: 8px;">
	...
	<div class="sub-cont" style="clear:left;">

		<br>
	</div>

		<div class="header-content1 addres-split" style="margin-bottom: 21px; font-size: 13px; font-family: Calibri;">
		<span class="content-bold" style="font-size: 22px;font-family: Calibri;">To :</span><br>
	...
	<div style="width:100%">
		<div style="width:60%;float:left;">
			<div class="header-content2" style="margin-bottom: 21px; font-size: 16px; font-family: Calibri;width:90%;">
		...
		<div style="width:40%;float:left;">
			<div class="header-content2" style="margin-bottom: 21px; font-size: 18px; font-family: Calibri; width: 90%;">
	...
	<table class="printTable" style="border:1px solid #000;font-family: Calibri; margin-top: 97px;margin-left: 0px;"> <!-- class="table table-bordered" -->
		<tbody>



			<tr>
			<tr class="bckcolor" style="font-family: Calibri;    font-weight: bold;margin-top: 80px;margin-left: 0px;height: 35px;">
				...
				<td rowspan="2" class="text-left" style="word-break: break-all;text-align: center;font-size: 16px;width:400px;">Description of Goods</td>
				<td class="text-left" style="text-align: center;    font-size: 16px;width:300px;">Vendor Product Desc</td>
			...
			<tr class="n-b" style="font-size: 16px;font-weight: bold;">
				...
				<%-- <c:if test="${poPage eq true }">
					<td style="word-break: break-all;font-size: 14px;font-weight: bold;width:200px;"><a href="javascript:void(0)"  class="anchor-description"  onclick="loadPriceMasterData('<%=splData[26]%>','<%= splData[2].replaceAll("[^A-Za-z 0-9]", "") %>','${site_idForPriceMaster}','${siteNameForPriceMaster}')">   <%= splData[2] %>  </a> </td>
				</c:if>
				<c:if test="${poPage eq false }"> --%>
					<td class="printTabletd" style="word-break: break-all;font-size: 14px;font-weight: bold;width:200px;"><%= splData[2] %></td>
			<%-- 	</c:if> --%>
				<td class="printTabletd" style="word-break: break-all;font-size: 14px;font-weight: bold;width:200px;"><%=splData[22]%></td>
				
			<td class="printTabletd" style="font-size: 14px;font-weight: bold;"><%=splData[4]%></td>
				<td class="printTabletd" style="font-size: 14px;font-weight: bold;"><%=splData[5]%></td>
				<td class="printTabletd" style="font-size: 14px;font-weight: bold;"><%=splData[6]%></td>
				<td class="printTabletd" style="font-size: 14px;font-weight: bold;"><%=splData[7]%></td>
				<td class="printTabletd" style="font-size: 14px;font-weight: bold;"><%=splData[8]%><span>%</span></td>
				<%-- 	<td><%=splData[9]%></td> --%>
				<td class="printTabletd" style="font-size: 14px;font-weight: bold;"><%= splData[10] %></td>
				<td class="printTabletd" style="font-size: 14px;font-weight: bold;"><%=splData[11]%></td>
				<td class="printTabletd" style="font-size: 14px;font-weight: bold;"><%=splData[12]%></td>
				<td class="printTabletd" style="font-size: 14px;font-weight: bold;"><%=splData[13]%></td>
				<%-- <td style="font-size: 14px;font-weight: bold;"><%= splData[14] %></td>
				<td style="font-size: 14px;font-weight: bold;"><%=splData[15]%></td> --%>
				<%-- <td><%=splData[16]%></td> --%>
				<td class="printTabletd" style="font-size: 14px;font-weight: bold;"><%=splData[17]%></td>
			...
			<% if(!ConveyanceName.equalsIgnoreCase("None")){  %>
			<tr>
				<td class="text-left printTabletd"><span class="contentBold"></span></td>
				<!-- <td class="text-left"><span class="contentBold"></span></td> -->
				<td class="text-left printTabletd"></td>
				<td class="text-left printTabletd"><input type="hidden" id="text-content3" /><span
					class="contentBold"></span></td>
				<td class="text-left printTabletd"><input type="hidden" id="text-content2" /><span
					class="contentBold"></span></td>
				<td class="text-left printTabletd"><span class="contentBold"></span></td>
				<td class="text-left printTabletd"><span class="contentBold"></span></td>
...
strTransportBasicAmt=String.format("%.2f",totalBasicAmount);
           ...
           <tr>
				...
				<td></td>
				<td style="word-break: break-all;font-size: 14px;font-weight: bold;width:200px;"></td>
				<td class="text-left"><input type="hidden" id="text-content4" /><span
					class="contentBold"></span></td>
				<td class="text-left"><input type="hidden" id="text-content2" /><span
					class="contentBold"></span></td>
	...
	<table class="printTable"  style="border:1px solid #000;font-family: Calibri;    font-weight: bold;margin-top: 98px;margin-left: 20px;">  <!-- class="table table-bordered" -->
		<tbody>
 ...
 strTransportBasicAmt=String.format("%.2f",totalBasicAmount);
           ...
           <tr>
				...
				<td></td>
				<td style="font-size: 14px;font-weight: bold;width: 200px;word-break: break-all;"></td>
				<td class="text-left"><input type="hidden" id="text-content4" /><span
					class="contentBold"></span></td>
				<td class="text-left"><input type="hidden" id="text-content2" /><span
					class="contentBold"></span></td>
			...
			<tr>
                <!-- <td></td><td></td> --><!-- <td></td> -->
                <td colspan="2" style="border: 2px solid black;" class="text-right"></td>
	...
	<div class="footer-content" style="margin-bottom:30px;">
		...
		<%
			...
			for (int i = 0; i < listOfTermsAndConditions.size(); i++) {
				...
				out.println("<span class='spanclass'>"+ ++sno + "."+ listOfTermsAndConditions.get(i) + "</span><br>");
...
<%
    ...
    if(strResponse.equalsIgnoreCase("true") && (poLevelComments!=null && !poLevelComments.equalsIgnoreCase(""))){%>
	 <p class="print-hide"><strong>Comments:</strong></p>
     <p class="print-hide"> <c:out value="${PoLevelComments}"></c:out></p>
     <%} %>
...
<div class="col-sm-3 pt-10">
					...
					<input type="hidden" name="poType" value="permanent">	<!-- this line is added for comparison  -->
...
<div id="myModal-pdf4" class="modal fade" role="dialog">
  ...
  <!-- modal popup for cancel perminent po -->
   <!-- Modal -->
	...
	<% } %>
	<button onclick="myFunction()" type="button" id="printPageButton" class="btn btn-warning" >Print</button>				
    </div>

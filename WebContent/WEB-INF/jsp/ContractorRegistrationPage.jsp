				...
				<div class="right_col" role="main">
					<div>
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active">Contractor Registration</li>
						</ol>
					</div>			
	<div align="center" class="contractor-page-content">
	<div align="center"><h1>Contractor Registration  </h1> </div>
...
<form:form action="saveContractorDetail.spring" modelAttribute="ContractorBean"  enctype="multipart/form-data" id="myForm" name="myForm" method="POST" class="form-horizontal">
	...
	<div class="col-md-6" style="text-align:left;">
	 ...
	 <div class="form-group">
 	   ...
 	   <div class="form-group">
	    <label for="inputdefault" class="col-md-5"> PAN Number<span class="astrik-imp"><sup>*</sup></span></label><span class="col-md-1"><strong>:</strong></span>
	...
	<div class="col-md-6" style="text-align:left;">
	  <div class="form-group">
	    <label for="inputdefault" class="col-md-5"> GSTIN</label><span class="col-md-1"><strong>:</strong></span>
	    <div class="col-md-6">
	...
	<div class="form-group">
	    ...
	    <div class="col-md-6">
	     <form:input path="ifsc_code"  type="text" autocomplete="off"  class="form-control" /></div>
 	 </div>
 	<div class="form-group">

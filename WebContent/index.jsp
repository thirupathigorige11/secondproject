...
<!-- 					<div class="form-group">
					...
					<div class="form-group">
						<div class="col-sm-12 col-xs-12">
							...
							<input type="text" class="form-control inputctrl"  id="frontend" name="site_id_backend" value=""  placeholder="Please enter site" required>
							<input type="hidden" class="form-control"  id="backend" name="site_id" value=""  placeholder="Please enter site">
					...
					%>  --%>
					<%-- <input type="text" id="errmsg" value="${Message}"> --%>
					<%--  <%} %>  --%>
					<%

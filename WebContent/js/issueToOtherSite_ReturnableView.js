...
function calculateOtherCharges() {
	...
	for(var j=0; j<snoId; j++) {
		var val = spltdData[j];
		var rec1 = document.getElementById("OtherOrTransportChargesId"+val).value;
		var rec2 = document.getElementById("TaxOnOtherOrTransportChargesId"+val).value;
		var rec3 = document.getElementById("OtherOrTransportChargesAfterTaxId"+val).value;
		var rec4 = document.getElementById("TotalAmountId"+val).value;
	...
	for(var i=0; i<chargeSnoId; i++) {
		...
		for(var x=0; x<snoId; x++) {
			...
			document.getElementById("OtherOrTransportChargesId"+val).value = r1;
			...
			document.getElementById("TaxOnOtherOrTransportChargesId"+val).value = r2;
			...
			document.getElementById("OtherOrTransportChargesAfterTaxId"+val).value = r3;
			...
			document.getElementById("TotalAmountId"+val).value = ttlAmnt;
...
*/
	...
	//alert("getAllProdsCount() "+getAllProdsCount());

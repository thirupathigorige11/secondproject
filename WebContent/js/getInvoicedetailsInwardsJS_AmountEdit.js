...
function calculateTotalAmount(qtyNum) {debugger;
...
function calcuLateFinalAmount() {
	...
	var tempAmnt = 0;
	 document.getElementById("finalAmntDiv").innerHTML = 0;
...
function editInvoiceRow(rowId){debugger;
	alert("Do you want to update the Invoice");
	$('#quantity' +rowId).prop('readonly',false);
	$('#price' +rowId).prop('readonly',false);
	$('#tax' +rowId).prop('readonly',false);
	$('#VendorNameId').prop('readonly',false);
	$('#VendorAddress').prop('readonly',false);
	$('#PONOId').prop('readonly',false);
	$('#PONOId').prop('readonly',false);
	$('#poDateId1').prop('readonly',false);
	$('#eWayBillNoId').prop('readonly',false);
	$('#vehileNoId').prop('readonly',false);
	$('#transporterNameId').prop('readonly',false);

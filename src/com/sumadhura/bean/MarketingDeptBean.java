...
public class MarketingDeptBean {
	...
	private double doubleTotalArea;
	private double doubleAVailableArea;
	private String strStatus;
	

	private int expenditureId;
	private String createdBy;
	private String expenditureMonth;
	private String expenditureType;

    private Integer previousexpendatureId;
    private String hoardingDate;
	private String rate;
	private String expendatureMonth;
	...
	public String getExpendatureMonth() {
		return expendatureMonth;
	}

	public void setExpendatureMonth(String expendatureMonth) {
		this.expendatureMonth = expendatureMonth;
	}

	public String getHoardingDate() {
		return hoardingDate;
	}

	public void setHoardingDate(String hoardingDate) {
		this.hoardingDate = hoardingDate;
	}
	...
	public Integer getPreviousexpendatureId() {
		return previousexpendatureId;
	}

	public void setPreviousexpendatureId(Integer previousexpendatureId) {
		this.previousexpendatureId = previousexpendatureId;
	}
	...
	public double getDoubleTotalArea() {
		return doubleTotalArea;
	}

	public void setDoubleTotalArea(double doubleTotalArea) {
		this.doubleTotalArea = doubleTotalArea;
	}

	public double getDoubleAVailableArea() {
		return doubleAVailableArea;
	}

	public void setDoubleAVailableArea(double doubleAVailableArea) {
		this.doubleAVailableArea = doubleAVailableArea;
	}
	...
	public void setStrPoAlreadyReceivedQuantity(
			double strPoAlreadyReceivedQuantity) {
	...
	public void setPurchaseDeptIndentProcessSeqId(
			String purchaseDeptIndentProcessSeqId) {
	...
	public int getExpenditureDetailsId() {
		return expenditureDetailsId;
	}

	public void setExpenditureDetailsId(int expenditureDetailsId) {
		this.expenditureDetailsId = expenditureDetailsId;
	}

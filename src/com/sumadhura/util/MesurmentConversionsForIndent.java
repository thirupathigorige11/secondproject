...
public class MesurmentConversionsForIndent {



	//converting the kg,grms to Packet(2.5 kg) this for all headless nails  // converting Foam sheet white 6feetx3feetx1mm
	public  Map<String ,String> convertCHP0016(double doubleActualQuantity,double inputQuantity,String inputMesurment){
		...
		try{
			...
			/*if(inputMesurment.equalsIgnoreCase("Kgs") || inputMesurment.equalsIgnoreCase("Kg")){
				...
				price=0;//(Double.parseDouble(basicAmount))/doubleConvertedQuantity;
				...
				price=0;//(Double.parseDouble(basicAmount))/convertedQuantity;
	...
	public  Map<String ,String> convertTiles(double doubleActualQuantity,double inputQuantity,String inputMesurment){
		...
		try{
			...
			try{
				if(inputMesurment.equalsIgnoreCase("Box")){
					...
					price=0;//(Double.parseDouble(basicAmnt))/convertedinputQuantityvalue;
					//price=Double.parseDouble(new DecimalFormat("##.##").format(price));
	...
	public  Map<String ,String> measurementConversionPatternOne(double doubleActualQuantity,double inputQuantity,String inputMesurment){
		double convertedinputQuantityvalue = 0.0;
		Map<String, String> gst = null;
		gst = new TreeMap<String, String>();
		double price=0.0;
	...
	public  Map<String ,String> measurementConversionPatternTwo(double doubleActualQuantity,double inputQuantity,String inputMesurment){
		double convertedinputQuantityvalue = 0.0;
		Map<String, String> gst = null;
		gst = new TreeMap<String, String>();
		double price=0.0;
		try{
			...
			try{
				if(inputMesurment.equalsIgnoreCase("Kgs") ){
					convertedinputQuantityvalue =    inputQuantity/doubleActualQuantity;
					price=0;//(Double.parseDouble(basicAmnt))/inputQuantity;
					//price=Double.parseDouble(new DecimalFormat("##.##").format(price));
					gst.put(String.valueOf(convertedinputQuantityvalue),String.valueOf(Double.parseDouble(new DecimalFormat("##.##").format(price))));
					System.out.println("converted value "+convertedinputQuantityvalue);
				}
	...
	public  Map<String ,String> measurementConversionPatternThree(double doubleActualQuantity,double inputQuantity,String inputMesurment){
		double convertedinputQuantityvalue = 0.0;
		Map<String, String> gst = null;
		gst = new TreeMap<String, String>();
		double price=0.0;
